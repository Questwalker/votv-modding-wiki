...
- [VoidMod (By Gato)](https://thunderstore.io/c/voices-of-the-void/p/Gatohost/VoidMod/) : This mod is the generally standardized framework for Voices of the Void modding, with useful functions, features and configuration control. It is *HIGHLY RECOMMENDED* as most mods require it as a dependency. The VotV Modding Wiki uses VoidMod in its modding tutorials.
