...
For example, if I wanted to create a mod called "My's Cool Mod", I would name this folder `MyCoolMod`. When you build and export your project, this will be the name of the `.pak` file you provide the Mod Loader with. Simplicity is key, but you can't name your Mod the same as another Mod, so I recommend personalizing your mod folder names.
