...
Anyone can make their own ghostmappings, but developers can make collections of ghostmappings that can be shared for anyone to use.

Currently, the [ghostmappings by ModestImpala](https://github.com/modestimpala/VotV_ghostmap) are recommended. Make sure to read the rest of the project's README for any important information, then they can downloaded by clicking the code button, and clicking "Download Zip", or by using the [releases](https://github.com/modestimpala/VotV_ghostmap/releases) section. Head into your Unreal Project's folder, and unpack the contents of the `Content` folder into the `Content` folder of your project.
