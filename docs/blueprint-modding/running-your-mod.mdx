...
id: running-your-mod
sidebar_position: 3
description: How to run your blueprint mod for testing
---
...
```
copy /y "<patch to your unreal engine's output>/pakchunk##-WindowsNoEditor.pak" "<path to your mod folder>\ExampleMod.pak"
```
