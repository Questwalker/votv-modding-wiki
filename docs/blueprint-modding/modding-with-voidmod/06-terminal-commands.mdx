...
Now, if I wanted to create a command called `ariral.silly`, and it took the first parameter and said it back to you, my Terminal Handler graph would look like this:
