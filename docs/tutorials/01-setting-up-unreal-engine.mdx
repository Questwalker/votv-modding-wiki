...
Be warned that installing the Engine will require around 40-45 gigabytes of storage space.
...
### Editor Preferences
Enable the checkbox "Allow ChunkID Assignments"

### Project Settings
Enable the checkbox "Generate Chunks"\
Disable the checkbox "Share Material Shader Code"
...
VictoryBPLibrary can also be installed globally, so that it becomes available in every project you create.

First, download the `VictoryPlugin27.zip` from [here](https://www.mediafire.com/file/1snjjuxuoqs6b4g/VictoryPlugin27.zip/file).

Find the location of your Unreal Engine installation, You'll want to extract the ZIP file to `UE_4.27/Engine/Plugins/Marketplace/VictoryBPLibrary`
...
Now, open any project file in Unreal Engine, the Victory Plugin should be available in the plugins menu.
